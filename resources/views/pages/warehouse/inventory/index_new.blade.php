<x-app-layout>
    <div class="min-h-screen px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto"
        ...
        <div class="flex items-center space-x-3 px-6 py-4 justify-between">
            ...
            <div x-data="{ modalOpenDetail: false }">
                ...
                <div x-show="modalOpenDetail" @click="modalOpenDetail = false"
                    ...
                    class="fixed inset-0 bg-black/40 backdrop-blur-lg z-40" aria-hidden="true" x-cloak>
                </div>
                ...
                <div x-show="modalOpenDetail" x-transition:enter="transition ease-out duration-300"
                    ...
                    @click.outside="modalOpenDetail = false" @keydown.escape.window="modalOpenDetail = false" x-cloak>

                    <div
                        class="w-full max-w-5xl bg-white/95 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                        <!-- Header -->
                        <div
                            class="px-6 py-5 flex justify-between items-center bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
                            <div class="flex items-center gap-3">
                                ...
                                <h2 class="text-lg font-semibold tracking-wide">Add New Inventory</h2>
                            </div>
                        ...
                        <div class="p-8 space-y-8">
                            <form id="inventoryForm" method="POST" action="/api/inventory/store" class="space-y-8">
                                @csrf

                                <!-- Row 1: Category & Inventory Code -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <label for="id_inventory_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Inventory
                                            Code</label>
                                        <input id="id_inventory_input" name="id_inventory_input" required
                                            autocomplete="off" placeholder="Enter inventory code"
                                            class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                    </div>
                                </div>
                                ...
                                <div id="otherCategoryDiv" class="hidden">
                                    <label for="otherCategory"
                                        class="block text-sm font-semibold text-gray-700 mb-2">Other Category</label>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        <label for="brand_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Brand</label>
                                        <input type="text" id="brand_input" name="brand_input"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <label for="qty_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Quantity</label>
                                        <input type="number" id="qty_input" name="qty_input" min="0"
                                            step="1" required placeholder="Enter quantity"
                                            class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition" />
                                    </div>
                                    <div>
                                        <label for="unit_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Unit</label>
                                ...
                                <!-- Row 4: MSRP, HPP & Currency -->
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <label for="currency_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">Currency</label>
                                    ...
                                    <div>
                                        <label for="msrp_input"
                                            class="block text-sm font-semibold text-gray-700 mb-2">MSRP</label>
                                        <div class="relative">
                                            <span id="currencySymbol"
                                                class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 font-medium">Rp</span>
                                            <input id="msrp_input" name="msrp_input" type="text"
                                                inputmode="numeric" placeholder="Enter price"
                                                class="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                ...
                                <div>
                                    <label for="hpp_input"
                                        class="block text-sm font-semibold text-gray-700 mb-2">HPP</label>
                                    <div class="relative">
                                        <span id="currencySymbolHpp"
                                            class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 font-medium">Rp</span>
                                        <input id="hpp_input" name="hpp_input" type="text" inputmode="numeric"
                                            placeholder="Enter HPP price"
                                            class="w-full border border-gray-300 rounded-xl pl-10 pr-4 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition"
                                            oninput="formatPrice(this)" />
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-end gap-4 pt-6 border-t border-gray-200">
                                    ...
                                    <button type="submit"
                                        class="px-6 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold text-sm hover:from-blue-700 hover:to-indigo-700 shadow-md transition">
                                        Save
                                    </button>
                                </div>
                            </form>
        ...
        <div class="sticky top-18 z-20 mb-6">
            ...
            <div class="overflow-x-auto">
                <div x-data="{ modalOpenDetail: false, modalData: {} }">
                    ...
                    <div x-show="modalOpenDetail" @click="modalOpenDetail = false"
                        ...
                        @click.outside="modalOpenDetail = false" aria-hidden="true" x-cloak>
                    </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="grid grid-cols-1 gap-4">
                                        <div class="bg-white/60 rounded-xl p-4 border border-gray-100 shadow-sm">
                                            ...
                                            <p class="font-semibold text-gray-900 text-lg" x-text="modalData.name">
                                            </p>
                                        </div>
                                        <div class="bg-white/60 rounded-xl p-4 border border-gray-100 shadow-sm">
                                            <p class="text-sm text-gray-500 mb-1">Category</p>
                                            <p class="font-semibold text-gray-900 text-lg"
                                                x-text="modalData.category"></p>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        function checkCategory() {
            ...
            otherDiv.classList.toggle('hidden', category !== 'Others');
        }
        ...
        function updateCurrencySymbol() {
            const selected = document.getElementById('currency_input').value;
            const symbol = selected === 'USD' ? '$' : 'Rp';
            document.getElementById('currencySymbol').textContent = symbol;
            document.getElementById('currencySymbolHpp').textContent = symbol;
            currency = selected;
        }
        ...
        function formatPrice(input) {
            ...
            input.value = currency === 'USD' ? formatted.replace(/\./g, ',') : formatted;
        }
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", async function(e) {
                ...
                const data = {
                    id_inventory: formData.get("id_inventory_input"),
                    category: formData.get("category_input") === "Others" ? formData.get(
                        "otherCategory") : formData.get("category_input"),
                    name: formData.get("name_input"),
                    brand: formData.get("brand_input"),
                    qty: formData.get("qty_input"),
                    unit: formData.get("unit_input"),
                    currency: formData.get("currency_input"),
                    pricelist: formData.get("msrp_input").replace(/[^\d]/g, ""),
                    hpp: formData.get("hpp_input").replace(/[^\d]/g, ""), // ✅ kirim HPP juga
                    is_active: 1
                };
                ...
                try {
                    ...
                    if (response.ok) {
                        ...
                        form.reset();
                        document.querySelector('[x-data]').__x.$data.modalOpenDetail = false;

                        if (typeof fetchInventories === "function") fetchInventories();
                    } else {
                        Toastify({
                            text: "❌ " + (result.message || "Failed to save inventory!"),
                            duration: 3000,
                            close: true,
                            gravity: "top",
                            position: "right",
                    ...
                    Toastify({
                        text: "⚠️ Network error or invalid response!",
                        duration: 3000,
                        close: true,
                        gravity: "top",
                        position: "right",
