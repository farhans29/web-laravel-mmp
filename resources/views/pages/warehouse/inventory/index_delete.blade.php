    ...
    <div class="min-h-screen px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto"
                            ...
                            <tr
                                ...
                                <td class="px-6 py-3 text-center space-x-2 flex justify-center">
                                    ...
                                    <button onclick="confirmDelete('{{ $inventory->id_inventory }}')"
                                        class="group relative flex items-center justify-center gap-2 px-4 py-2 rounded-xl font-semibold text-sm text-white bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 shadow-md hover:shadow-lg transition-all duration-300 ease-in-out cursor-pointer">
                                        <!-- Icon Trash --> <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <span
                                            class="absolute inset-0 rounded-xl bg-white/10 opacity-0 group-hover:opacity-100 transition duration-300"></span>
                                    </button>
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="bg-white/80 backdrop-blur-md border border-gray-200 shadow-sm p-5 mt-5 rounded-2xl">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <!-- Show per page -->
                <form method="GET" action="{{ route('indexDelete.inventory') }}" class="flex items-center gap-3">
    ...
    <script>
        ...
        async function confirmDelete(id) {
            const result = await Swal.fire({
                ...
                background: '#fdfdfd',
                color: '#1f2937',
                confirmButtonColor: '#e11d48', // merah elegan
            ...
            fetch(`/warehouse/inventory/delete/${id}`, {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        // Hapus baris dari tabel dengan animasi halus
